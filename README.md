...
사용자의 '감'에 의존하던 기존 방식 대신, \*\*경험적 데이터\*\*와 **우선순위 알고리즘**을 활용하여 가장 현실적이고 실행 가능한 주간 계획표를 자동으로 생성합니다.
...
| 문제점 (Pain Point)                        | MakePlan의 해결책 (Solution)                                 | 검증된 효과            |
| :----------------------------------------- | :----------------------------------------------------------- | :--------------------- |
...
```bash
git clone https://github.com/your-username/make-plan.git
cd make-plan
```
...
3.  가장 중요한 과제부터 순서대로 빈 슬롯을 점유(Occupying)합니다.
